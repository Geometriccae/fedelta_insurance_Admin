...
(function () {
    ...
    //         if(pickrContainerPrimary) pickrContainerPrimary.appendChild(el);
    ...
    //     if(themeContainerPrimary) themeContainerPrimary.appendChild(el);
    // }
    // nanoButtons[0].click();
    /* for theme primary */
    ...
    //     button.addEventListener('click', () => {
    //         const el = document.createElement('p');
    //         if(pickrContainerBackground) pickrContainerBackground.appendChild(el);
    ...
    //         });
    //     });
    //     if(themeContainerBackground) themeContainerBackground.appendChild(button);
    // }
